OC.L10N.register(
    ...
    "Failed to delete recipe" : "No s'ha pogut suprimir la recepta",
    "Cooking time is up!" : "S'ha acabat el temps de cocció!",
    "Could not update recipe" : "No s'ha pogut actualitzar la recepta",
    "Could not add recipe" : "No s'ha pogut afegir la recepta",
    "Could not rebuild recipe index." : "No s'ha pogut tornar a crear l'índex de receptes.",
    ...
    "Error" : "Error",
    "This page doesn't exist." : "Aquesta pàgina no existeix.",
    "Create recipe" : "Crea una recepta",
    "Recipe URL" : "URL de la recepta",
    "Download recipe" : "Baixa la recepta",
    "Settings" : "Paràmetres",
