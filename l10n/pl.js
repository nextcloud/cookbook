OC.L10N.register(
    ...
    "Warning %u occurred %u times while parsing %s." : "Ostrzeżenie %u wystąpiło %u razy podczas analizowania %s.",
    "Error %u occurred %u times while parsing %s." : "Błąd %u wystąpił %u razy podczas analizowania %s.",
    "Fatal error %u occurred %u times while parsing %s." : "Błąd krytyczny %u wystąpił %u razy podczas analizowania %s.",
