OC.L10N.register(
    ...
    "Could not parse recipe tools. Expected array or string." : "Kunde inte tolka receptverktyg. Förväntade mig en array eller sträng.",
    "Could not find recipe in HTML code." : "Kunde inte hitta recept i HTML-kod.",
    "JSON cannot be decoded." : "JSON kunde inte tolkas.",
    "No recipe was found." : "Ingen recept hittades.",
    ...
    "Could not parse timestamp {timestamp}" : "Kunde inte tolka tidsstämpel {timestamp}",
    ...
    "Failed to update name of category \"{category}\"" : "Kunde inte uppdatera namnet på kategorin \"{category}\"",
    ...
    "Enter URL or select from your Nextcloud instance on the right" : "Ange URL eller välj din Nextcloud-instans till höger",
    ...
    "Tools" : "Verktyg",
    "Frontend debug settings" : "Frontend felsökningsinställningar",
    ...
    "Could not save visible info blocks" : "Kunde inte spara synliga informationsblock.",
    ...
    "Trans Fat" : "Transfett",
    "Loading…" : "Läser in…",
    "The ingredient cannot be recalculated due to incorrect syntax. Please change it to this syntax: amount unit ingredient. Examples: 200 g carrots or 1 pinch of salt" : "Ingrediensen kan inte räknas om på grund av felaktig syntax. Ändra det till denna syntax: mängd enhet ingrediens. Exempel: 200 g morötter eller 1 nypa salt",
    ...
    "Cannot download image using curl" : "Kan inte ladda ner bilden med curl",
    ...
    "_{minutes}m_::_{minutes}m_" : ["{minuter}m","{minuter}m"],
