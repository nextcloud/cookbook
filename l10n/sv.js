OC.L10N.register(
    ...
    "Could not set recipe folder to {path}" : "Kunde inte välja receptkatalog eller sökväg",
    ...
    "Failed to delete recipe" : "Misslyckades med att ta bort recept",
    "Could not update recipe" : "Kunde inte uppdatera recept",
    "Could not add recipe" : "Kunde inte lägga till recept",
    "Could not rebuild recipe index." : "Kunde inte bygga om receptindex",
    "Cookbook" : "Kokbok",
    ...
    "Keywords (comma-separated)" : "Nyckelord (kommaseparerad)",
    "Servings" : "Portioner",
    "Tools" : "Verktyg",
