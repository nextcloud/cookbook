OC.L10N.register(
    ...
    "Unsupported type of transmitted data. This is a bug, please report it." : "Ej stödd typ av överförd data. Detta är ett fel, vänligen rapportera det.",
    ...
    "Exception while downloading recipe from %s.: %s" : "Fel vid nedladdning av recept från %s.: %s",
