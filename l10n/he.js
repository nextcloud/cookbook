OC.L10N.register(
    ...
    "Failed to delete recipe" : "מחיקת המתכון נכשלה",
    "Cooking time is up!" : "זמן הבישול תם!",
    "Could not update recipe" : "לא ניתן לעדכן את המתכון",
    "Could not add recipe" : "לא ניתן להוסיף מתכון",
    "Could not rebuild recipe index." : "לא ניתן לבנות את מפתח המתכונים.",
    ...
    "Total time" : "זמן כולל",
    "Category" : "קטגוריה",
    "Keywords (comma-separated)" : "מילות מפתח (מופרדות בפסיקים)",
    "Servings" : "מנות",
    "Tools" : "כלים",
    "Ingredients" : "רכיבים",
    "Instructions" : "הנחיות",
    ...
    "Error" : "שגיאה",
    "This page doesn't exist." : "עמוד זה אינו קיים.",
    "Create recipe" : "יצירת מתכון",
    "Recipe URL" : "כתובת מתכון",
    "Download recipe" : "הורדת מתכון",
    "Settings" : "הגדרות",
