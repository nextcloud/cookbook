OC.L10N.register(
    ...
    "Warning %u occurred %u times while parsing %s." : "分析 %s 時出現 %u 次警告 %u。",
    "Error %u occurred %u times while parsing %s." : "分析 %s 時出現 %u 次錯誤 %u。",
    "Fatal error %u occurred %u times while parsing %s." : "分析 %s 時發生 %u 次致命錯誤 %u。",
