OC.L10N.register(
    ...
    "Unsupported type of transmitted data. This is a bug, please report it." : "نوع البيانات المرسل غير مدعوم؛ وهذا يُعدُّ خطأً. رجاء قم بالإبلاغ عنه.",
    ...
    "Unexpected node received for recipe folder." : "تم استلام وحدة node غير متوقعة لمجلد الوصفات.",
    ...
    "Please select option first." : "يرجى تحديد اختيار أولا.",
    ...
    "Show recipes containing any selected keyword" : "عرض الوصفات التي تحوي أيّاً من كلمات البحث",
    "Show recipes containing all selected keywords" : "عرض الوصفات التي تحوي جميع كلمات البحث",
    "Clear" : "محو",
    ...
    "Preparation time" : "زمن التحضير",
    "Cooking time" : "زمن الطهي",
    "Total time" : "الزمن الكُلِّي",
    ...
    "Serving size" : "حجم حصة التقديم لكل شخصٍ",
    ...
    "Trans-fat content" : "محتوى الدهون المتحولة",
