OC.L10N.register(
    ...
    "Cannot read content of JSON file %s" : "تعذّرت قراءة ملف الـ JSON ـ %s",
    "Cannot download image using curl" : "تعذّر تنزيل الصورة باستعمال أمر \"مهام في الخلفية\" curl",
    "Filter current recipes" : "فلتِر الوصفات الحالية",
    ...
    "Show settings for filtering recipe list" : "أظهِِر إعدادات فلترة قائمة الوصفات",
    "Order" : "طلب",
    "Show filter settings" : "أظهِر إعدادات الفلترة",
    ...
    "Show recipes containing all selected categories" : "أظهِر الوصفات التي تحوي كل الفئات المحددة",
    "All keywords" : "كل كلمات البحث",
    "Show recipes containing any selected keyword" : "أعرُض الوصفات التي تحوي أيّاً من كلمات البحث",
    "Show recipes containing all selected keywords" : "أعرُض الوصفات التي تحوي جميع كلمات البحث",
    "Clear" : "محو",
    "_1 category selected_::_{n} categories selected_" : ["{n} فئة تمّ تحديدها","1 فئة تمّ تحديدها","{n} فئة تمّ تحديدها","{n} فئة تمّ تحديدها","{n} فئات تمّ تحديدها","{n} فئة تمّ تحديدها"],
    "_1 keyword selected_::_{n} keywords selected_" : ["{n} كلمة بحثٍ تمّ تحديدها","1 كلمة بحثٍ تمّ تحديدها","{n} كلمة بحثٍ تمّ تحديدها","{n} كلمة بحثٍ تمّ تحديدها","{n} كلمات بحثٍ تمّ تحديدها","{n} كلمة بحثٍ تمّ تحديدها"],
    "Recipe filters" : "فلاتر الوصفات",
    "Matching all selected categories" : "مطابقة كل الفئات المحددة",
    "Matching any selected category" : "المطابقة مع أيٍّ من الفئات المحددة",
    "Matching all selected keywords" : "المطابقة مع جميع كلمات البحث المحددة",
    "Matching any selected keyword" : "المطابقة مع أيٍّ من الفئات المحددة",
    "Apply" : "حفظ",
    "Show filters and sorting in recipe lists" : "أظهِر الفلاتر و الفرز في قوائم الوصفات",
    "Preparation time (hours:minutes:seconds)" : "زمن التحضير (ساعات:دقائق:ثواني)",
    "Cooking time (hours:minutes:seconds)" : "زمن الطبخ (ساعات:دقائق:ثواني)",
    "Total time (hours:minutes:seconds)" : "الزمن الإجمالي (ساعات:دقائق:ثواني)",
    ...
    "_{seconds}s_::_{seconds}s_" : ["{seconds} ث","{seconds} ث","{seconds} ث","{seconds} ث","{seconds} ث","{seconds} ث"],
