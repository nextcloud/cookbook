OC.L10N.register(
    ...
    "_Only a single number was found in the \"recipeYield\" field. Using it as number of servings._::_There are %n numbers found in the \"recipeYield\" field. Using the highest number found as number of servings._" : ["\"\"رىتسىپچىقار\" ئورۇندا بىر سانلار تېپىلدى. ئۇنى مۇلازىمەت سانى قىلىپ ئىشلىتىدۇ.","\"\"رىتسىپچىقار\" ئورۇندا %n سانلار تېپىلدى. ئەڭ چوڭ ساننى مۇلازىمەت سانى قىلىپ ئىشلىتىدۇ."],
    ...
    "Cannot combine whitespace characters." : "بوشلۇق ھەرىپلىرىنى بىرلەشتۈرگىلى بولمىدى",
    ...
    "_Warning %u occurred while parsing %s._::_Warning %u occurred %n times while parsing %s._" : ["%s نى يىشىۋاتقاندا %u ئاگاھلاندۇرۇشى يۈز بەردى","%s نى يىشىۋاتقاندا %u ئاگاھلاندۇرۇشى %n قېتىم يۈز بەردى"],
    "_Error %u occurred while parsing %s._::_Error %u occurred %n times while parsing %s._" : ["%s نى يىشىۋاتقاندا %u خاتالىقى يۈز بەردى","%s نى يىشىۋاتقاندا %u خاتالىقى %n قېتىم يۈز بەردى"],
    "_Fatal error %u occurred while parsing %s._::_Fatal error %u occurred %n times while parsing %s._" : ["%s نى يىشىۋاتقاندا %u ئېغىر خاتالىقى يۈز بەردى","%s نى يىشىۋاتقاندا %u ئېغىر خاتالىقى %n قېتىم يۈز بەردى"],
    "First time it occurred in line %u and column %u" : "تۇنجى قېتىم %u قۇر ۋە%u ئىستونىدا يۈز بەردى",
    ...
    "Unsupported type of transmitted data. This is a bug, please report it." : "قوللىمايدىغان تىپتىكى ئەۋەتىلگەن سانلىق-مەلۇمات. بۇ بىر قۇرت، ئۇنى دوكىلات قىلىڭ.",
    ...
    "Could not parse timestamp {timestamp}" : "ۋاقىت جەدۋىلى {timestamp} نى تەھلىل قىلالمىدى",
    ...
    "Exception while downloading recipe from %s.: %s" : "%s دىن رېتسىپنى چۈشۈرۋاتقاندا بىر تاسادىبىيلىق: %s",
    ...
    "Unexpected node received for recipe folder." : "رېتسىپ قىسقۇچىغا ئۇشتۇمتۇت نوقتا تاپشۇرۋالدى",
    ...
    "Cookbook settings" : "رېتسىپ دەپتىرى تەڭشەكلىرى",
    ...
    "Could not set recipe update interval to {interval}" : "رېتسېپ يېڭىلاش ئارىلىقىنى {interval} تەڭشىيەلمىدى",
    ...
    "Discard changes?" : "ئۆزگەرتىشلەرنى تاشلىۋېتەمسىز؟",
    ...
    "_{hours}h_::_{hours}h_" : ["{hours} س","{hours}س"],
    "_{minutes}m_::_{minutes}m_" : ["{minutes}م","{minutes} م"],
    "_{seconds}s_::_{seconds}s_" : ["{seconds}س","{seconds}س"],
    "{item} copied to clipboard" : "{item} چاپلاش تاختىسىغا كۆچۈرۈلدى",
    "Copying {item} to clipboard failed" : "چاپلاش تاختىسىغا {item} نى كۆچۈرۈش مەغلۇب بولدى",
    "ingredients" : "تەركىبلەر",
    "Loading…" : "يۈكلەۋاتىدۇ…",
    ...
    "Failed to load recipes with keywords: {tags}" : "ئاچقۇچلۇق سۆزلەر بىلەن رېتسېپلارنى يۈكلىيەلمىدى: {tags}",
