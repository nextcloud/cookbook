OC.L10N.register(
    ...
    "Warning %u occurred %u times while parsing %s." : "%u kódú figyelmeztetést történt %u alkalommal a(z) %s feldolgozása során.",
    "Error %u occurred %u times while parsing %s." : "%u kódú hiba történt %u alkalommal a(z) %s feldolgozása során.",
    "Fatal error %u occurred %u times while parsing %s." : "%u kódú végzetes hiba történt %u alkalommal a(z) %s feldolgozása során.",
