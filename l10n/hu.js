OC.L10N.register(
    ...
    "_Warning %u occurred while parsing %s._::_Warning %u occurred %n times while parsing %s._" : ["%u kódú figyelmeztetést történt %n alkalommal a(z) %s feldolgozása során.","%u kódú figyelmeztetést történt %n alkalommal a(z) %s feldolgozása során."],
    "_Error %u occurred while parsing %s._::_Error %u occurred %n times while parsing %s._" : ["%u kódú hiba történt %n alkalommal a(z) %s feldolgozása során.","%u kódú hiba történt %n alkalommal a(z) %s feldolgozása során."],
    "_Fatal error %u occurred while parsing %s._::_Fatal error %u occurred %n times while parsing %s._" : ["%u kódú végzetes hiba történt %n alkalommal a(z) %s feldolgozása során.","%u kódú végzetes hiba történt %n alkalommal a(z) %s feldolgozása során."],
