OC.L10N.register(
    ...
    "Invalid URL-encoded string found. Please report a bug." : "Érvénytelen URL-kódolású karakterlánc található. Jelentsen be hibát.",
    "Recipes" : "Receptek",
    "in %s" : "itt:  %s",
    ...
    "Reload recipe" : "Töltse be újra a receptet",
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the Cookbook app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "Vendégfiókkal van bejelentkezve, ezért nem hozhat létre tetszőleges fájlokat és mappákat ezen a Nextcloud példányon. Ahhoz, hogy vendégként használhassa a Cookbook alkalmazást, meg kell adnia egy mappát, ahol az összes recept tárolásra kerül. Szüksége lesz írási engedélyre ebbe a mappába.",
    "Select recipe folder" : "Válassza ki a recept mappát",
    "Path to your recipe collection" : "Útvonal a recept gyűjteményed",
    "Create recipe" : "Recept létrehozása",
    "Uncategorized recipes" : "Kategóriák nélküli receptek",
    "Categories" : "Kategóriák",
    "Rename" : "Átnevezés",
    "Enter new category name" : "Írja be az új kategória nevét",
    "Download recipe from URL" : "A recept letöltése az URL-ről",
    "Toggle editing" : "Szerkesztés be- és kikapcsolása",
    "Failed to load category {category} recipes" : "Nem sikerült betölteni a(z) {category} kategória receptjeit",
    "The server reported an error. Please check." : "A szerver hibát jelentett. Kérem ellenőrizze.",
    "Could not query the server. This might be a network problem." : "Nem sikerült lekérdezni a szervert. Ez hálózati problémát jelenthet.",
    "Loading category recipes …" : "Kategória receptek betöltése …",
    ...
    "Show keyword cloud in recipe lists" : "Kulcsszavak mutatása a recept listákban",
    "Could not set preference for image printing" : "Nem sikerült beállítani a képnyomtatás preferenciáját",
    ...
    "Calories" : "Kalória",
    "E.g.: 450 kcal (amount & unit)" : "Pl .: 450 kcal (mennyiség és egység)",
    "Carbohydrate content" : "Szénhidráttartalom",
    "E.g.: 2 g (amount & unit)" : "Pl .: 2 g (mennyiség és egység)",
    "Cholesterol content" : "Koleszterin tartalom",
    ...
    "Unknown answer returned from server. See logs." : "Ismeretlen válasz érkezett a szervertől. Nézd meg a logokat.",
    "No answer for request was received." : "A kérésre nem érkezett válasz.",
    "Could not start request to save recipe." : "Nem lehet kérést indítani a recept elmentésére.",
    ...
    "Failed to load search results" : "Nem sikerült betölteni a keresési eredményeket"
},
