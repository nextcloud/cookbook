OC.L10N.register(
    ...
    "URL resolves to a local/internal address" : "A webcím helyi/belső címre oldódik fel",
    "Error occurred while downloading the file: %s" : "Hiba történt a fájl letöltése során: %s",
    ...
    "Could not parse the nutrition information successfully for recipe {name}." : "A(z) {name} recept tápértékadatai nem dolgozhatók fel.",
    ...
    "Could not parse recipe tools. Expected array or string." : "A recepthez szükséges eszközök nem dolgozhatóak fel. Tömböt vagy karakterláncot kell megadni.",
    ...
    "Cannot combine whitespace characters." : "A szóköz karakterek nem kombinálhatóak.",
    ...
    "Unsupported type of transmitted data. This is a bug, please report it." : "Az átadott adatok típusa nem támogatott. Ez egy hiba, jelezze.",
    ...
    "Could not parse timestamp {timestamp}" : "Nem sikerült feldolgozni az időbélyeget: {timestamp}",
    ...
    "in %s" : "itt:  %s",
    "Cannot read content of JSON file %s" : "Nem lehet olvasni a(z) %s JSON-fájl tartalmát",
    ...
    "Exception while downloading recipe from %s.: %s" : "Kivétel a recept letöltésekor innen: %s.: %s",
    ...
    "Unexpected node received for recipe folder." : "Váratlan csomópont fogadva a receptmappához.",
    ...
    "Save" : "Mentés",
    "Search" : "Keresés",
    "Filter current recipes" : "Jelenlegi receptek szűrése",
    "Filter" : "Szűrés",
    ...
    "Failed to update name of category \"{category}\"" : "Nem sikerült frissíteni a(z) „{category}” kategória nevét",
    ...
    "Cookbook main menu" : "Receptkönyv főmenü",
    "Create recipe" : "Recept létrehozása",
    "Download recipe from URL" : "Recept letöltése a webcímről",
    ...
    "Enter URL or select from your Nextcloud instance on the right" : "Adja meg a webcímet vagy válasszon a Nextcloud-példányáról a jobb oldalon",
    ...
    "Delete nutrition item" : "Tápértékadat törlése",
    ...
    "Show recipes containing any selected category" : "Kiválasztott kategóriát tartalmazó receptek megjelenítése",
    "Show recipes containing all selected categories" : "Összes kiválasztott kategóriát tartalmazó receptek megjelenítése",
    "All keywords" : "Összes kulcsszó",
    "Keywords" : "Kulcsszavak",
    "Show recipes containing any selected keyword" : "Bármely kiválasztott kulcsszót tartalmazó receptek megjelenítése",
    "Show recipes containing all selected keywords" : "Összes kiválasztott kulcsszót tartalmazó receptek megjelenítése",
    "Clear" : "Törlés",
    "Recipe filters" : "Receptszűrők",
    "Matching all selected categories" : "Összes kiválasztott kategóriának megfelelő",
    "Matching any selected category" : "Bármely kiválasztott kategóriának megfelelő",
    "Matching all selected keywords" : "Összes kiválasztott kulcsszónak megfelelő",
    ...
    "Order keywords alphabetically" : "Betűrendi felsorolás",
    "Toggle keyword" : "Kulcsszó be/ki",
    "Keyword not contained in visible recipes" : "A kulcsszó nem szerepel a látható receptekben",
    "Toggle keyword area size" : "Kulcsszóterület méretének váltása",
    "Creation date" : "Létrehozás dátuma",
    "Modification date" : "Módosítás dátuma",
    "Select order" : "Válasszon sorrendet",
    "Could not set preference for image printing" : "A képnyomtatás beállításai nem adhatók meg",
    ...
    "Control which blocks of information are shown in the recipe view. If you do not use some features and find them distracting, you may hide them." : "Adja meg, hogy mely információs blokkok jelenjenek meg receptnézetben. Ha nem használ egy funkciót, és zavarónak találja, akkor elrejtheti.",
    ...
    "Tools" : "Eszközök",
    "Frontend debug settings" : "Felhasználói felület hibakeresési beállításai",
    ...
    "Saturated-fat content" : "Telítettzsír-tartalom",
    "Serving size" : "Adag",
    ...
    "Unsaturated-fat content" : "Telítetlenzsír-tartalom",
    "Failed to fetch keywords" : "A kulcsszavak lekérése sikertelen",
    "Unknown answer {status} returned from server. See logs in your browser (press F12)." : "Ismeretlen válasz ({status}) érkezett a kiszolgálótól. Nézze meg a böngésző naplóit (nyomja meg az F12-t).",
    "No answer for request was received." : "A kérésre nem érkezett válasz.",
    "Could not start request to save recipe." : "Nem lehet receptmentési kérést indítani.",
    "Clone of {name}" : "{name} másolata",
    ...
    "Copying {item} to clipboard failed" : "A(z) {item} vágólapra másolása sikertelen volt.",
    "ingredients" : "hozzávalók",
    "Loading…" : "Betöltés…",
