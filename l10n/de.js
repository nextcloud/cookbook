OC.L10N.register(
    ...
    "Failed to delete recipe" : "Löschen des Rezepts ist fehlgeschlagen",
    "Cooking time is up!" : "Die Kochzeit ist vorbei!",
    "Could not update recipe" : "Rezept konnte nicht aktualisiert werden",
    "Could not add recipe" : "Rezept konnte nicht hinzugefügt werden.",
    "Could not rebuild recipe index." : "Rezept-Index konnte nicht neu aufgebaut werden.",
    ...
    "URL" : "URL",
    "Image" : "Bild",
    "Pick a local image" : "Wähle eine lokale Bilddatei aus",
    "Preparation time" : "Vorbereitungsdauer",
    "Cooking time" : "Kochdauer",
    "Total time" : "Gesamtzeit",
    "Category" : "Kategorie",
    "Keywords (comma-separated)" : "Schlagworte (durch Kommas getrennt)",
    "Servings" : "Portionen",
    "Tools" : "Utensilien",
    "Ingredients" : "Zutaten",
    ...
    "Download recipe" : "Rezept herunterladen",
