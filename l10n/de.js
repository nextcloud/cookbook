OC.L10N.register(
    ...
    "_Only a single number was found in the `recipeYield` field. Using it as number of servings._::_There are %n numbers found in the `recipeYield` field. Using the highest number found as number of servings._" : ["Es wurde eine einzige Zahl im Feld `recipeYield` gefunden, verwende diese als Anzahl Portionen.","Es wurden %n Zahlen im Feld `recipeYield` gefunden, verwende die größte Zahl als Anzahl Portionen."],
