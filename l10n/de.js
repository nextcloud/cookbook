OC.L10N.register(
    ...
    "Could not find recipe in HTML code." : "Rezept in HTML-Code konnte nicht gefunden werden",
    ...
    "Warning %u occurred %u times while parsing %s." : "Warnung %u trat %u Mal beim Parsen von %s auf",
    "Error %u occurred %u times while parsing %s." : "Fehler %u trat %u Mal beim Parsen von %s auf",
    "Fatal error %u occurred %u times while parsing %s." : "Schwerer Fehler %u trat %u Mal beim Parsen von %s auf",
