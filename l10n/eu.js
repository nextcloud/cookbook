OC.L10N.register(
    ...
    "Could not guess image url as no recipe url was found." : "Ezin izan da irudiaren url-a estimatu ez delako errezetaren url-a aurkitu.",
    "Could not guess image url scheme from recipe url %s" : "Ezin izan da irudiaren url eskema estimatu %s errezetaren url-tik.",
    ...
    "_Only a single number was found in the `recipeYield` field. Using it as number of servings._::_There are %n numbers found in the `recipeYield` field. Using the highest number found as number of servings._" : ["Kopuru bakarra aurkitu da `recipeYield` eremuan. Plater kopururako erabiliko da."," %n kopuru aurkitu dira `recipeYield` eremuan. Aurkitutako zenbaki handiena erabiliko da plater kopururako."],
    ...
    "Servings" : "Anoak",
    "Toggle if the number of servings are present" : "Aldatu plater kopurua badago",
