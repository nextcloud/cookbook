OC.L10N.register(
    ...
    "Warning %u occurred %u times while parsing %s." : "%u abisua%u aldiz gertatu da %s analizatzean.",
    "Error %u occurred %u times while parsing %s." : "%u errorea %u aldiz gertatu da %sanalizatzean.",
    "Fatal error %u occurred %u times while parsing %s." : "Errore larria %u %u aldiz gertatu da %s analizatzean.",
