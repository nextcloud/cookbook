OC.L10N.register(
    ...
    "Warning %u occurred %u times while parsing %s." : "Uyarı: %s işlenirken %u ile %u kez karşılaşıldı.",
    "Error %u occurred %u times while parsing %s." : "Hata: %s işlenirken %u ile %u kez karşılaşıldı.",
    "Fatal error %u occurred %u times while parsing %s." : "Ciddi hata: %s işlenirken %u ile %u kez karşılaşıldı.",
