OC.L10N.register(
    ...
    "URL resolves to a local/internal address" : "Adres yerel/iç bir adrese çözümleniyor",
    "Error occurred while downloading the file: %s" : "Dosya indirilirken sorun çıktı: %s",
    "No content encoding was detected in the content." : "İçerikte bir içerik kodlayıcı bulunamadı.",
    "Recipe name cannot be processed." : "Tarif adı işlenemedi.",
    ...
    "Cannot combine whitespace characters." : "Boşluk karakteri kullanılamaz.",
    ...
    "User cannot create recipe folder" : "Kullanıcı yemek tarifi klasörü oluşturamaz",
    "in %s" : "%s içinde",
    ...
    "Exception while downloading recipe from %s.: %s" : "Tarif %s üzerinden indirilirken sorun çıktı: %s",
    ...
    "Cookbook main menu" : "Yemek kitabı ana menüsü",
    ...
    "To get started, you may use the text box in the left navigation bar to import a new recipe. Click below to create a recipe from scratch." : "Başlamak için yeni bir yemek tarifi içe aktarmak üzere sol gezinme çubuğundaki yazı kutusunu kullanabilirsiniz. Sıfırdan bir yemek tarifi oluşturmak için aşağıya tıklayın.",
    "No recipes" : "Herhangi bir yemek tarifi yok",
    "Create new recipe!" : "Yeni yemek tarifi oluştur!",
    "Name" : "Ad",
    ...
    "You have unsaved changes! Do you still want to leave?" : "Kaydedilmemiş değişiklikleriniz var. Yine de ayrılmak istiyor musunuz?",
    "Calories" : "Kalori",
