OC.L10N.register(
    ...
    "All keywords" : "Todas as palabras clave",
    ...
    "Matching all selected keywords" : "Coincidencia con todas as palabras clave seleccionadas",
    "Matching any selected keyword" : "Coincidencia con calquera palabra clave seleccionada",
    "Apply" : "Aplicar",
    ...
    "Could not set preference for image printing" : "Non foi posíbel definir a preferencia para a impresión de imaxes",
    "Could not set recipe update interval to {interval}" : "Non foi posíbel definir o intervalo de actualización de receitas a {interval}",
    "Could not save visible info blocks" : "Non foi posíbel gardar os bloques de información visíbeis",
    "Could not set recipe folder to {path}" : "Non foi posíbel  definir o cartafol de receitas en {path}",
    ...
    "Unknown answer {status} returned from server. See logs in your browser (press F12)." : "Resposta descoñecida {status} devolta polo servidor. Vexa os rexistros no seu navegador (prema F12).",
