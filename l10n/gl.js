OC.L10N.register(
    ...
    "Could not set preference for image printing" : "Non foi posíbel establecer a preferencia para a impresión de imaxes",
    "Path to your recipe collection" : "Rúa á súa colección de receitas",
    "Could not set recipe folder to {path}" : "Non foi posíbel  establecer o cartafol de receitas en {path}",
    ...
    "Failed to delete recipe" : "Produciuse un fallo ao eliminar a receita",
    "Cooking time is up!" : "Xa acabou o tempo de cociñar!",
    "Could not update recipe" : "Non foi posíbel actualizar a receita",
    "Could not add recipe" : "Non foi posíbel engadir a receita",
    "Could not rebuild recipe index." : "Non foi posíbel  reconstruír o índice de receitas.",
    ...
    "Cooking time" : "Tempo de cocción",
    "Total time" : "Tempo total",
    "Category" : "Categoría",
    "Keywords (comma-separated)" : "Palabras clave (separadas por coma)",
    "Servings" : "Racións",
    "Tools" : "Trebellos",
    ...
    "Error" : "Erro",
    "This page doesn't exist." : "Non existe esta páxina",
    "Create recipe" : "Crear unha receita",
    "Recipe URL" : "URL da receita",
    "Download recipe" : "Descargar receita",
    "Settings" : "Axustes",
