OC.L10N.register(
    ...
    "The provided URL is not allowed." : "Zadaná URL není umožněna.",
    ...
    "Create new recipe!" : "Vytvořte nový recept!",
    "Name" : "Název",
    "Show settings for filtering recipe list" : "Zobrazit nastavení pro filtrování seznamu receptů",
    "Order" : "Pořadí",
    "Show filter settings" : "Zobrazit nastavení filtru",
    "Filter name" : "Název filtru",
    "Search term" : "Hledat pojem",
    "All categories" : "Veškeré kategorie",
    "Show recipes containing any selected category" : "Zobrazit recepty obsahující libovolnou z označených kategorií",
    "Show recipes containing all selected categories" : "Zobrazit recepty, které obsahují veškeré vybrané kategorie",
    "All keywords" : "Všechna klíčová slova",
    "Keywords" : "Klíčová slova",
    "Show recipes containing any selected keyword" : "Zobrazit recepty, obsahující libovolné označené klíčové slovo",
    "Show recipes containing all selected keywords" : "Zobrazí recepty, obsahující všechna vybraná klíčová slova",
    "Clear" : "Vyčistit",
    "Recipe filters" : "Filtry receptů",
    "Matching all selected categories" : "Odpovídající všem vybraným kategoriím",
    "Matching any selected category" : "Odpovídající libovolné označené kategorii",
    "Matching all selected keywords" : "Odpovídající všem označeným klíčovým slovům",
    "Matching any selected keyword" : "Odpovídající libovolnému označenému klíčovému slovu",
    "Apply" : "Použít",
    ...
    "Show filters and sorting in recipe lists" : "Zobrazit filtry a řazení v seznamu receptů",
    ...
    "Unknown answer {status} returned from server. See logs in your browser (press F12)." : "Ze serveru byla přijata neznámá odpověď {status}. Prohlédněte si záznamy událostí ve svém prohlížeči (stiskněte F12).",
    ...
    "URL" : "URL",
    "Image" : "Obrázek",
    "Preparation time (hours:minutes:seconds)" : "Doba přípravy (hodin:minut:sekund)",
    "Cooking time (hours:minutes:seconds)" : "Doba tepelné úpravy (hodin:minut:sekund)",
    "Total time (hours:minutes:seconds)" : "Celková doba (hodin:minut:sekund)",
