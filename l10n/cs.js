OC.L10N.register(
    ...
    "Warning %u occurred %u times while parsing %s." : "Při zpracovávání %s se vyskytlo varování %u – %u krát.",
    "Error %u occurred %u times while parsing %s." : "Při zpracovávání %s se vyskytla chyba %u – %u krát.",
    "Fatal error %u occurred %u times while parsing %s." : "Při zpracovávání %s se vyskytla zásadní chyba %u – %u krát.",
