OC.L10N.register(
    ...
    "Could not guess image url as no recipe url was found." : "Nedaří se uhádnout URL adresu obrázku, protože nebyla nalezena žádná URL receptu.",
    ...
    "Could not parse `recipeYield` field. Falling back to 1 serving." : "Nedaří se zpracovat kolonku `recipeYield` field. Náhradně je předpokládána jedna porce.",
    ...
    "Servings" : "Porce",
    "Toggle if the number of servings are present" : "Zapnout pokud je k dispozici počet porcí",
