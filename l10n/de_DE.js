OC.L10N.register(
    ...
    "Could not guess image url scheme from recipe url %s" : "Konnte das Foto-URL-Schema nicht aus der Rezept-URL %s ermitteln.",
    ...
    "Using heuristics to parse the `recipeYield` field representing the number of servings of recipe {name}." : "Heuristiken zum Analysieren des Felds `recipeYield` verwenden, das die Anzahl Portionen des Rezepts {name} enthält.",
    "_Only a single number was found in the `recipeYield` field. Using it as number of servings._::_There are %n numbers found in the `recipeYield` field. Using the highest number found as number of servings._" : ["Es wurde ein einzige Zahl im Feld `recipeYield` gefunden, verwende diese als Anzahl Portionen.","Es wurden %n Zahlen im Feld `recipeYield` gefunden, verwende die größte Zahl als Anzahl Portionen."],
    ...
    "Servings" : "Portionen",
    "Toggle if the number of servings are present" : "Umschalten, wenn die Anzahl der Portionen vorhanden ist",
