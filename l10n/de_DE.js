OC.L10N.register(
    ...
    "The provided URL is not allowed." : "Die angegebene URL ist unzulässig.",
    "Recipe with ID %d was not found in database." : "Rezept mit der ID %d wurde in der Datenbank nicht gefunden.",
    "URL resolves to a local/internal address" : "URL führt zu einer lokalen/internen Adresse",
    "Error occurred while downloading the file: %s" : "Es ist ein Fehler beim Herunterladen der Datei aufgetreten: %s",
    ...
    "Cannot parse recipe: Unknown object found during flattening of instructions." : "Rezept konnte nicht analysiert werden: Unbekanntes Objekt bei der Interpretation der Anweisungsschritte gefunden.",
    ...
    "Cookbook main menu" : "Kochbuch-Hauptmenü",
    ...
    "Show recipes containing any selected category" : "Rezepte anzeigen, die ein ausgewählte Kategorie enthalten",
    ...
    "Show recipes containing any selected keyword" : "Rezepte anzeigen, die ein ausgewähltes Schlüsselwort enthalten",
    ...
    "Matching any selected category" : "Passend zu einer der ausgewählten Kategorien",
    "Matching all selected keywords" : "Passend zu allen ausgewählten Schlüsselworten",
    "Matching any selected keyword" : "Passend zu einem der ausgewählten Schlüsselworte",
    "Apply" : "Anwenden",
    ...
    "Could not set recipe update interval to {interval}" : "Das Rezept-Aktualisierungsintervall konnte nicht auf {interval} gesetzt werden",
    "Could not save visible info blocks" : "Sichtbare Infoblöcke konnten nicht gespeichert werden",
    "Could not set recipe folder to {path}" : "Pfad '{path}' konnte nicht als Rezept-Ordner gesetzt werden",
    ...
    "Control which blocks of information are shown in the recipe view. If you do not use some features and find them distracting, you may hide them." : "Steuern, welche Informationsblöcke in der Rezeptansicht angezeigt werden. Wenn Sie einige Funktionen nicht verwenden und sie als störend empfinden, können Sie sie ausblenden.",
    ...
    "This allows to temporarily enable logging in the browser console in case of problems. You will not need these settings by default." : "Dadurch kann die Protokollierung in der Browserkonsole bei Problemen vorübergehend aktiviert werden. Standardmäßig wird diese Einstellung nicht benötigt.",
    "Enable debugging" : "Fehlersuche aktivieren",
    "The page was not found" : "Die Seite wurde nicht gefunden",
    "You have unsaved changes! Do you still want to leave?" : "Sie haben nicht gespeicherte Änderungen! Wollen Sie diese Seite verlassen?",
    "Calories" : "Kalorien",
    ...
    "Unknown answer {status} returned from server. See logs in your browser (press F12)." : "Unbekannte Antwort {status} vom Server erhalten. Bitte die Protokolle im Browser ansehen (F12 drücken).",
