OC.L10N.register(
    ...
    "Failed to delete recipe" : "Recept sa nepodarilo odstrániť ",
    "Cooking time is up!" : "Čas varenia vypršal!",
    "Could not update recipe" : "Recept sa nepodarilo aktualizovať",
    "Could not add recipe" : "Recept sa nepodarilo pridať",
    "Could not rebuild recipe index." : "Nepodarilo sa znova vytvoriť index receptov.",
    ...
    "Error" : "Chyba",
    "This page doesn't exist." : "Táto stránka neexistuje.",
    "Create recipe" : "Vytvoriť recept",
    "Recipe URL" : "URL receptu",
    "Download recipe" : "Stiahnuť recept",
    "Settings" : "Nastavenia",
