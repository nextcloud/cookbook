OC.L10N.register(
    ...
    "The provided URL is not allowed." : "Zadaná URL adresa nie je povolená.",
    "Recipe with ID %d was not found in database." : "Recept s ID %d nebol nájdený v databázi.",
    "URL resolves to a local/internal address" : "URL adresa smeruje na lokálnu/internú adresu",
    "Error occurred while downloading the file: %s" : "Pri sťahovaní súboru nastala chyba: %s",
    ...
    "Unsupported type of transmitted data. This is a bug, please report it." : "Nepodporovaný typ prenášaných údajov. Toto je chyba, nahláste ju.",
    ...
    "in %s" : "v %s",
    "Cannot read content of JSON file %s" : "Nedá sa prečítať obsah JSON súboru %s",
    ...
    "Exception while downloading recipe from %s.: %s" : "Výnimka pri sťahovaní receptu z %s.: %s",
    ...
    "Unexpected node received for recipe folder." : "Pre adresár receptov bol prijatý neočakávaný uzol.",
    "Another recipe with that name already exists" : "Iný recept s tým istým menom už existuje",
    "Cannot download image using curl" : "Nedá sa stiahnuť obrázok pomocou curl",
    ...
    "Delete confirmation" : "Potvrdenie odstránenia",
    ...
    "Cookbook main menu" : "Hlavná ponuka Kuchárky",
    ...
    "Unknown answer {status} returned from server. See logs in your browser (press F12)." : "Server vrátil neznámu odpoveď {status}. Pozrite si protokoly v prehliadači (stlačte F12).",
