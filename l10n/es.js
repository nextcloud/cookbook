OC.L10N.register(
    ...
    "The provided URL is not allowed." : "La URL suministrada no está permitida.",
    ...
    "Recipe name cannot be processed." : "No se ha podido procesar el nombre de la receta.",
    ...
    "Cannot combine whitespace characters." : "No se pueden combinar caracteres de espacio en blanco.",
    ...
    "Unsupported type of transmitted data. This is a bug, please report it." : "Tipo de datos transmitidos no soportados. Esto es un error, por favor, reporte el mismo.",
    ...
    "Exception while downloading recipe from %s.: %s" : "Excepción al descargar receta de %s: %s",
    ...
    "Unexpected node received for recipe folder." : "Nodo inesperado recibido para la carpeta de recetas.",
