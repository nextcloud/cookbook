OC.L10N.register(
    ...
    "Warning %u occurred %u times while parsing %s." : "La advertencia %u ocurrió %u veces mientras se analizaba %s.",
    "Error %u occurred %u times while parsing %s." : "El error %u ocurrió %u veces mientras se analizaba %s.",
    "Fatal error %u occurred %u times while parsing %s." : "El error fatal %u ocurrió %u veces mientras se analizaba %s.",
