OC.L10N.register(
    ...
    "Path to your Recipe Image" : "Ruta a tu colección de recetas",
    "Are you sure you want to delete this recipe?" : "¿Realmente quieres borrar la receta?",
    "Failed to delete recipe" : "No se ha podido borrar la receta",
    "Cooking time is up!" : "¡Se acabó el tiempo de cocción!",
    "Could not update recipe" : "No fue posible actualizar la receta",
    "Could not add recipe" : "No fue posible añadir la receta",
    "Could not rebuild recipe index." : "No fue posible recrear el índice de recetas.",
    ...
    "Download recipe" : "Descargar receta",
    "Settings" : "Ajustes",
