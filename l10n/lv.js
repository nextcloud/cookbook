OC.L10N.register(
    ...
    "Path to your Recipe Image" : "Receptes attēla atrašanās vieta",
    "Are you sure you want to delete this recipe?" : "Vai vēlaties dzēst šo recepti?",
    "Failed to delete recipe" : "Receptes dzēšana neizdevās",
    "Cooking time is up!" : "Gatavošanas laiks beidzies.",
    "Could not update recipe" : "Nevar atjaunināt recepti",
    "Could not add recipe" : "Nevar pievienot recepti",
    "Could not rebuild recipe index." : "Nevar izveidot jaunu recepšu indeksu.",
    ...
    "Category" : "Kategorija",
    "Keywords (comma-separated)" : "Atslēgvārdi (atdalīti ar komatu)",
    "Servings" : "Porcijas",
    ...
    "Error" : "Kļūda",
    "This page doesn't exist." : "Šī lapa neeksistē.",
    "Create recipe" : "Izveidot recepti",
    "Recipe URL" : "Receptes URL",
    "Download recipe" : "Lejupielādēt recepti",
