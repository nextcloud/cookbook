OC.L10N.register(
    ...
    "The provided URL is not allowed." : "Ní cheadaítear an URL a cuireadh ar fáil.",
    "Recipe with ID %d was not found in database." : "Níor aimsíodh oideas le haitheantas %d sa bhunachar sonraí.",
    "URL resolves to a local/internal address" : "Réitíonn an URL chuig seoladh áitiúil/inmheánach",
    "Error occurred while downloading the file: %s" : "Tharla earráid agus an comhad á íoslódáil: %s",
    "No content encoding was detected in the content." : "Níor aimsíodh aon ionchódú inneachair san ábhar.",
    "Recipe name cannot be processed." : "Ní féidir ainm an oidis a phróiseáil.",
    ...
    "Cannot combine whitespace characters." : "Ní féidir carachtair spásbhána a chomhcheangal.",
    ...
    "Exception while downloading recipe from %s.: %s" : "Eisceacht agus oideas á íoslódáil ó%s.:%s",
    ...
    "Delete confirmation" : "Deimhniú scriosta",
    ...
    "Cookbook main menu" : "Príomh-roghchlár an leabhair chócaireachta",
