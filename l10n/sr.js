OC.L10N.register(
    ...
    "Cannot combine whitespace characters." : "Не могу да се комбинују карактери празног простора.",
    ...
    "Exception while downloading recipe from %s.: %s" : "Изузетак током преузимања рецепта са %s.: %s",
    ...
    "Name" : "Име",
    "Show settings for filtering recipe list" : "Приказује подешавања за филтрирање листе рецепата",
    "Order" : "Редослед",
    "Show filter settings" : "Прикажи подешавања филтера",
    "Filter name" : "Име филтера",
    "Search term" : "Појам претраге",
    "All categories" : "Све категорије",
    "Show recipes containing any selected category" : "Приказује рецепте који садрже било коју од изабраних категорија",
    "Show recipes containing all selected categories" : "Приказује рецепте који садрже све категорије",
    "All keywords" : "Све кључне речи",
    ...
    "Matching all selected keywords" : "Подудара се са свим изабраним кључним речима",
    "Matching any selected keyword" : "Подудара се са било којом изабраном кључном речи",
    "Apply" : "Примени",
    ...
    "Show filters and sorting in recipe lists" : "Приказује филтере и сортирање у листи рецепата",
    ...
    "Discard changes?" : "Да одбацим измене?",
    "Description" : "Опис",
    "URL" : "URL",
    "Image" : "Слика",
    "Preparation time (hours:minutes:seconds)" : "Време припреме (сати:минута:секунди)",
    "Cooking time (hours:minutes:seconds)" : "Време кувања (сати:минута:секунди)",
    "Total time (hours:minutes:seconds)" : "Укупно време (сати:минута:секунди)",
    ...
    "_{hours}h_::_{hours}h_" : ["{hours}ч","{hours}ч","{hours}ч"],
    "_{minutes}m_::_{minutes}m_" : ["{minutes}м","{minutes}м","{minutes}м"],
    "_{seconds}s_::_{seconds}s_" : ["{seconds}с","{seconds}с","{seconds}с"],
