OC.L10N.register(
    ...
    "Path to your Recipe Image" : "Caminho para a sua Imagem da Receita",
    "Are you sure you want to delete this recipe?" : "Tem que certeza que quer eliminar esta receita?",
    "Failed to delete recipe" : "Falhou a eliminação da receita",
    "Cooking time is up!" : "Terminou o tempo de cozedura!",
    "Could not update recipe" : "Não foi possível refrescar a receita",
    "Could not add recipe" : "Não foi possível adicionar receita",
    "Could not rebuild recipe index." : "Não foi possível reconstruir o índice de receitas.",
    ...
    "Category" : "Categoria",
    "Keywords (comma-separated)" : "Palavras-chave (separadas por vírgulas)",
    "Servings" : "Porções",
    "Tools" : "Utensílios",
    ...
    "Download recipe" : "Descarregar receita",
