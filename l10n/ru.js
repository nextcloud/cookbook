OC.L10N.register(
    ...
    "Recipes" : "Рецепты",
    "The user folder cannot be created due to missing permissions." : "Папка пользователя не может быть создана из-за отсутствия разрешений.",
    ...
    "Add" : "Добавить",
    "To get started, you may use the text box in the left navigation bar to import a new recipe. Click below to create a recipe from scratch." : "Чтобы начать, вы можете использовать текстовое поле на левой панели навигации для импорта нового рецепта. Нажмите ниже, чтобы создать рецепт с нуля.",
    "Create new recipe!" : "Создайте новый рецепт!",
    ...
    "Tools" : "Инструменты",
    "Frontend debug settings" : "Настройки отладки внешнего интерфейса",
    "This allows to temporarily enable logging in the browser console in case of problems. You will not need these settings by default." : "Это позволяет временно включить логирование в консоли браузера в случае возникновения проблем. По умолчанию эти настройки вам не понадобятся.",
