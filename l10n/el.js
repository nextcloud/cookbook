OC.L10N.register(
    ...
    "Failed to delete recipe" : "Η διαγραφή συνταγής απέτυχε",
    "Cooking time is up!" : "Ο χρόνος μαγειρέματος έχει φτάσει!",
    "Could not update recipe" : "Δεν μπορεί να γίνει ενημέρωση συνταγής",
    "Could not add recipe" : "Δεν μπορεί να προστεθεί η συνταγή",
    "Could not rebuild recipe index." : "Δεν ήταν δυνατή η αναδημιουργία καταλόγου συνταγής.",
    ...
    "Error" : "Σφάλμα",
    "This page doesn't exist." : "Η σελίδα δεν υπάρχει.",
    "Create recipe" : "Δημιουργία συνταγής",
    "Recipe URL" : "Διεύθυνση URL συνταγής",
    "Download recipe" : "Λήψη συνταγής",
    "Settings" : "Ρυθμίσεις",
